...
> **⚠️ Solo para prototipos rápidos.** Para proyectos reales, usar Next.js → ver [REACT_INTEGRATION.md](REACT_INTEGRATION.md) sección "Next.js". Next.js ofrece SSR/SEO, routing, componentes reutilizables y deploy trivial en Vercel.
